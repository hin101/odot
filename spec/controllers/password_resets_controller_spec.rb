  ...
  describe "PATCH update" do
    context "with no token found" do
      it "renders the edit page" do
        patch :update, id: 'notfound', user: { password: 'password', password_confirmation: 'password'}
        expect(response).to render_template('edit')
      end
    ...
    context "with a valid token" do
      ...
      it "updates the user's password" do
        ...
        patch :update, id: user.password_reset_token, user: { password: 'password', password_confirmation: 'password'}
        user.reload
