...
describe "Creating todo lists" do 
	...
	it "displays an error when the todo list has a title less then three characters" do
		expect(TodoList.count).to eq(0)
		visit "/todo_lists" 
		click_link "New Todo list"
		expect(page).to have_content("New todo_list")
	...
	it "displays an error when the todo list has description less then three characters" do
		expect(TodoList.count).to eq(0)
		visit "/todo_lists" 
		click_link "New Todo list"
		expect(page).to have_content("New todo_list")
