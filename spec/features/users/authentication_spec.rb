...
describe "Loggin In" do
  it "logs the user in and goes to the todo lists" do
  	User.create(first_name:"Jason", last_name:"Seifer", email: "jason@teamtreehouse.com", password: "treehouse1234", password_confirmation: "treehouse1234")
  ...
  it "displays the email address in the event of a failed login" do
  	...
  	expect(page).to have_content("There was a problem loggin in, Please check your credentials.")
